// Medidhisubbaiah Trust Initial Data Store

export const initialServices = [
  {
    id: 1,
    title: "Free Tailoring Program",
    category: "Skill Development",
    shortDescription: "Free tailoring training and support programs empowering women and youth with self-reliance skills.",
    fullDescription: "Our Free Tailoring Training Program is designed to foster financial independence and self-employment among women and underprivileged youth in the community. Over a 3-to-6 month intensive hands-on course, students master garment cutting, stitching, embroidery basics, and modern garment assembly techniques. Upon completion, participants receive certified qualifications and guidance on setting up their own tailoring units.",
    icon: "Scissors",
  ...
  },
  {
    ...
    category: "Skill Development",
    shortDescription: "Free heritage embroidery and Maggam zardosi craft training for sustainable artisan livelihoods.",
    fullDescription: "The Free Maggam Work Program preserves rich traditional Indian embroidery art while creating high-earning home-based artisan opportunities. Trainees learn intricate Aari needle work, zardosi, stone fixing, bead attachment, and bridal blouse designing. This skill enables artisans to earn handsome daily wages or establish boutique partnerships.",
    icon: "Sparkles",
  ...
  },
  {
    ...
    category: "Education",
    shortDescription: "Official certification ceremonies celebrating student achievement and boosting vocational employability.",
  ...
  },
  {
    ...
    category: "Healthcare",
    shortDescription: "Life-saving voluntary blood donation camps and 24/7 emergency donor helpline network.",
  ...
  },
  {
    ...
    shortDescription: "Freshly prepared wholesome and nutritious meals served to needy, hospital attendants, and homeless individuals.",
  ...
  },
  {
    ...
    category: "Community Welfare",
    shortDescription: "Monthly dry ration and nutrition kits delivered to elderly, widows, and economically vulnerable households.",
  ...
  {
    id: 7,
    title: "Chalivendram (Drinking Water Service)",
  ...
  {
    id: 8,
    title: "Sports Events & Programs",
    category: "Sports",
    shortDescription: "Organizing tournaments, athletics meets, and distributing free sports kits for youth development.",
  ...
  },
  {
    ...
    category: "Education",
    shortDescription: "Free school kit distribution, tuition support, merit scholarships, and competitive exam guidance.",
...
export const initialStats = [
  { label: "Women & Youth Trained", value: "2,050+", icon: "Users", change: "+24% this year" },
  { label: "Blood Units Donated", value: "4,200+", icon: "HeartPulse", change: "100% voluntary" },
...
export const trustInfo = {
  ...
  tagline: "Dedicated to Community Upliftment, Compassion, and Self-Reliance",
  registration: "Regd. Social Welfare & Charitable Trust",
  founded: "Serving the Community with Pride & Transparency",
  address: "Medidhisubbaiah Trust Bhavan, Main Road, Beside Gandhi Statue, Andhra Pradesh, India",
  phone: "+91 98480 12345 / +91 94401 67890",
  emergencyBloodHelpline: "+91 98480 99999",
  email: "contact@medidhisubbaiahtrust.org",
  operatingHours: "Monday - Saturday: 08:30 AM - 06:30 PM (Sunday: Community Outreaches)",
  socials: {
